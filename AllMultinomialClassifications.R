...
baseline<- mean(predict(svm.mclass.linear, test.x)==as.factor(test.y))
perm_imp<- sapply(seq_len(ncol(test.x)), function(j){
  Xp<- test.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.mclass.linear, Xp)==as.factor(test.y))
})
...
baseline<- mean(predict(svm.mclass.poly, test.x)==as.factor(test.y))
perm_imp<- sapply(seq_len(ncol(test.x)), function(j){
  Xp<- test.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.mclass.poly, Xp)==as.factor(test.y))
})
...
#displaying permutation feature importance 
baseline<- mean(predict(svm.mclass.radial, test.x)==as.factor(test.y))
perm_imp<- sapply(seq_len(ncol(test.x)), function(j){
  Xp<- test.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.mclass.radial, Xp)==as.factor(test.y))
})
...
#displaying permutation feature importance
baseline<- mean(predict(svm.mclass.sigmoid, test.x)==as.factor(test.y))
perm_imp<- sapply(seq_len(ncol(test.x)), function(j){
  Xp<- test.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.mclass.sigmoid, Xp)==as.factor(test.y))
})
...
#displaying permutation feature importance
baseline<- mean(predict(knn.mclass, test.x)==as.factor(test.y))
perm_imp<- sapply(seq_len(ncol(test.x)), function(j){
  Xp<- test.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(knn.mclass, Xp)==as.factor(test.y))
})
...
#displaying permutation feature importance 
baseline<- mean(predict(nb.mclass, test.x)==as.factor(test.y))
perm_imp<- sapply(seq_len(ncol(test.x)), function(j){
  Xp<- test.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(nb.mclass, Xp)==as.factor(test.y))
})
...
baseline_prob<- predict(ann.mclass, test.x)
