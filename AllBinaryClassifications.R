...
baseline<- mean(predict(svm.class.poly, train.x)==as.factor(train.y))
perm_imp<- sapply(seq_len(ncol(train.x)), function(j){
  Xp<- train.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.class.poly, Xp)==as.factor(train.y))
})
...
#displaying permutation feature importance based on average accuracy
baseline<- mean(predict(svm.class.radial, train.x)==as.factor(train.y))
perm_imp<- sapply(seq_len(ncol(train.x)), function(j){
  Xp<- train.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.class.radial, Xp)==as.factor(train.y))
})
...
#displaying permutation feature importance based on average accuracy
baseline<- mean(predict(svm.class.sigmoid, train.x)==as.factor(train.y))
perm_imp<- sapply(seq_len(ncol(train.x)), function(j){
  Xp<- train.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(svm.class.sigmoid, Xp)==as.factor(train.y))
})
...
#displaying permutation feature importance based on average accuracy
baseline<- mean(predict(knn.biclass, train.x)==as.factor(train.y))
perm_imp<- sapply(seq_len(ncol(train.x)), function(j){
  Xp<- train.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(knn.biclass, Xp)==as.factor(train.y))
})
...
#displaying permutation feature importance based on average accuracy
baseline<- mean(predict(nb.biclass, train.x)==as.factor(train.y))
perm_imp<- sapply(seq_len(ncol(train.x)), function(j){
  Xp<- train.x
  Xp[,j]<- sample(Xp[,j])
  mean(predict(nb.biclass, Xp)==as.factor(train.y))
})
...
baseline_prob<- predict(ann.biclass, train.x)
